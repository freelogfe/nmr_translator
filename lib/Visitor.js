...
class Visitor extends mappingVisitor {
    ...
    visitDownline_presentation_rule(ctx) {
        this.mappingRule.operation = 'downline';
    ...
    visitPresentation_name(ctx) {
        this.mappingRule.presentation = this.__getFullRowString(ctx);
    ...
    visitThe_candidate(ctx) {
        ...
        if (candidate.startsWith('$:')) {
            ...
            this.mappingRule.candidate.version = release[1] || 'latest';
    ...
    visitReplaced(ctx) {
        ...
        this.mappingRule.replaced.version = replaced[1] || 'latest';
    ...
    visitReplacer(ctx) {
        ...
        if (replacer.startsWith('$:')) {
            ...
            this.mappingRule.replacer.version = release[1] || 'latest';
