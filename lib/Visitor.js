...
class Visitor extends MappingVisitor {
    ...
    visitAddRule(ctx) {
        ...
        // this.mappingRule.title = null;
        // this.mappingRule.cover = null;
    ...
    visitAddAttrBase(ctx) {
        this.attr.customType = 'base';
        super.visitAddAttrBase(ctx);
    }

    visitAddAttrSelect(ctx) {
        this.attr.customType = 'select';
        this.attr.options = [];
        super.visitAddAttrSelect(ctx);
    }

    visitAddAttrSelectOptions(ctx) {
        super.visitAddAttrSelectOptions(ctx);
    }

    visitAddAttrSelectOption(ctx) {
        const text = this.__getFullRowString(ctx);
        this.attr.options.push(text);
        super.visitAddAttrSelectOption(ctx);
    }

    visitAddAttrInput(ctx) {
        this.attr.customType = 'input';
        super.visitAddAttrInput(ctx);
    }
